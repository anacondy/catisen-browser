...
impl AdBlocker {
    ...
    pub fn should_block_request(&self, url: &str) -> bool {
        ...
        // Use the URL as both request URL and source URL; type = "script" is
        // a conservative choice that matches broad rules without being too
        // aggressive on first-party assets.
        match AdRequest::new(url, url, "script") {
